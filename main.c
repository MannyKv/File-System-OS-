...
extern void TestBadVolumeName(CuTest *);
extern void TestCreateLudicrousNumberOfFiles(CuTest *);
extern void TestWriteExactlyBlock(CuTest *);
extern void TestWriteMaxFile(CuTest *);
extern void TestWriteTooLargeFile(CuTest *);
extern void TestCreateLotsSameOfFiles(CuTest *);
extern void TestCreateFilesInDifferentDirs(CuTest *);
...
void RunAllTests(void)
{
    ...
    // SUITE_ADD_TEST(suite, TestBadVolumeName);
    // SUITE_ADD_TEST(suite, TestCreateLudicrousNumberOfFiles);
    //  SUITE_ADD_TEST(suite, TestWriteExactlyBlock);
    // SUITE_ADD_TEST(suite, TestWriteMaxFile);
    // SUITE_ADD_TEST(suite, TestWriteTooLargeFile);
    // SUITE_ADD_TEST(suite, TestCreateLotsSameOfFiles);
    // SUITE_ADD_TEST(suite, TestCreateFilesInDifferentDirs);
